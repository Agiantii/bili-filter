...
function createSearchBox() {
  ...
  searchContainer.className = 'billi-filter-container';

  // 创建搜索框
  const searchInput = document.createElement('input');
  searchInput.id = 'billi-filter-search';
  searchInput.className = 'billi-filter-search';
  searchInput.type = 'text';
  searchInput.placeholder = '输入关键词筛选视频...';

  // 创建搜索图标
  const searchIcon = document.createElement('span');
  searchIcon.className = 'billi-filter-icon';
  searchIcon.innerHTML = '🔍';

  // 创建清除按钮
  const clearButton = document.createElement('span');
  clearButton.className = 'billi-filter-clear';
